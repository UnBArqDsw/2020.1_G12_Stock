...
|   Noção   |   Impacto   |   Sinônimos    |
|  :-----:  |  :-------:  |  :---------:   |
| Microempresa é o pequeno negócio que tem como característica: o rendimento bruto anual de até R$360 mil. | Micro empresas realizam [controle de estoque](Modeling/verbo?id=Controle-de-Estoque)(Modeling/objeto?id=Estoque). <br><br> Contrata [fornecedor](Modeling/objeto?id=Fornecedor). | Pequeno negócio. |
