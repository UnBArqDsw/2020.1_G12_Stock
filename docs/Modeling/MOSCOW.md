...
## MoSCoW
Essa técnica é utilizada para priorizar os [requisitos funcionais](Modeling/objeto?id=requisito-funcional) elicitados, então segue abaixo os requisitos com as suas devidas priorizações.
